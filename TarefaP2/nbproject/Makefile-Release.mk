...
${OBJECTDIR}/Teste1.o: Teste1.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Teste1.o Teste1.c

${OBJECTDIR}/Teste2.o: Teste2.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Teste2.o Teste2.c

${OBJECTDIR}/Teste3.o: Teste3.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Teste3.o Teste3.c

${OBJECTDIR}/context/contexts.o: context/contexts.c
	${MKDIR} -p ${OBJECTDIR}/context
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/context/contexts.o context/contexts.c

${OBJECTDIR}/context/ucontext.o: context/ucontext.c
	${MKDIR} -p ${OBJECTDIR}/context
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/context/ucontext.o context/ucontext.c

${OBJECTDIR}/context/ucontext.o: context/ucontext.s
	${MKDIR} -p ${OBJECTDIR}/context
	$(AS) $(ASFLAGS) -o ${OBJECTDIR}/context/ucontext.o context/ucontext.s

${OBJECTDIR}/context/ucontext_asm.o: context/ucontext_asm.S
	${MKDIR} -p ${OBJECTDIR}/context
	$(AS) $(ASFLAGS) -o ${OBJECTDIR}/context/ucontext_asm.o context/ucontext_asm.S

${OBJECTDIR}/contexts.o: contexts.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/contexts.o contexts.c
...
${OBJECTDIR}/ppos_core.o: ppos_core.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ppos_core.o ppos_core.c
